...
let e={data:""},t=t=>"object"==typeof window?((t?t.querySelector("#_goober"):window._goober)||Object.assign((t||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:t||e,l=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,a=/\/\*[^]*?\*\/|  +/g,n$1=/\n+/g,o=(e,t)=>{let r="",l="",a="";for(let n in e){let c=e[n];"@"==n[0]?"i"==n[1]?r=n+" "+c+";":l+="f"==n[1]?o(c,n):n+"{"+o(c,"k"==n[1]?"":t)+"}":"object"==typeof c?l+=o(c,t?t.replace(/([^,])+/g,e=>n.replace(/(^:.*)|([^,])+/g,t=>/&/.test(t)?t.replace(/&/g,e):e?e+" "+t:t)):n):null!=c&&(n=/^--/.test(n)?n:n.replace(/[A-Z]/g,"-$&").toLowerCase(),a+=o.p?o.p(n,c):n+":"+c+";");}return r+(t&&a?t+"{"+a+"}":a)+l},c={},s$1=e=>{if("object"==typeof e){let t="";for(let r in e)t+=r+s$1(e[r]);return t}return e},i$2=(e,t,r,i,p)=>{let u=s$1(e),d=c[u]||(c[u]=(e=>{let t=0,r=11;for(;t<e.length;)r=101*r+e.charCodeAt(t++)>>>0;return "go"+r})(u));if(!c[d]){let t=u!==e?e:(e=>{let t,r,o=[{}];for(;t=l.exec(e.replace(a,""));)t[4]?o.shift():t[3]?(r=t[3].replace(n$1," ").trim(),o.unshift(o[0][r]=o[0][r]||{})):o[0][t[1]]=t[2].replace(n$1," ").trim();return o[0]})(e);c[d]=o(p?{["@keyframes "+d]:t}:t,r?"":"."+d);}return ((e,t,r)=>{-1==t.data.indexOf(e)&&(t.data=r?e+t.data:t.data+e);})(c[d],t,i),d},p=(e,t,r)=>e.reduce((e,l,a)=>{let n=t[a];if(n&&n.call){let e=n(r),t=e&&e.props&&e.props.className||/^go/.test(e)&&e;n=t?"."+t:e&&"object"==typeof e?e.props?"":o(e,""):!1===e?"":e;}return e+l+(null==n?"":n)},"");function u(e){let r=this||{},l=e.call?e(r.p):e;return i$2(l.unshift?l.raw?p(l,[].slice.call(arguments,1),r.p):l.reduce((e,t)=>Object.assign(e,t&&t.call?t(r.p):t),{}):l,t(r.target),r.g,r.o,r.k)}u.bind({g:1});u.bind({k:1});function m$1(e,t,r,l){o.p=t;}

var i$1=new Map([["align-self","-ms-grid-row-align"],["color-adjust","-webkit-print-color-adjust"],["column-gap","grid-column-gap"],["gap","grid-gap"],["grid-template-columns","-ms-grid-columns"],["grid-template-rows","-ms-grid-rows"],["justify-self","-ms-grid-column-align"],["margin-inline-end","-webkit-margin-end"],["margin-inline-start","-webkit-margin-start"],["overflow-wrap","word-wrap"],["padding-inline-end","-webkit-padding-end"],["padding-inline-start","-webkit-padding-start"],["row-gap","grid-row-gap"],["scroll-margin-bottom","scroll-snap-margin-bottom"],["scroll-margin-left","scroll-snap-margin-left"],["scroll-margin-right","scroll-snap-margin-right"],["scroll-margin-top","scroll-snap-margin-top"],["scroll-margin","scroll-snap-margin"],["text-combine-upright","-ms-text-combine-horizontal"]]);function n(n,r){let t="";const a=i$1.get(n);a&&(t+=`${a}:${r};`);const o=function(i){var n=/^(?:(text-(?:decoration$|e|or|si)|back(?:ground-cl|d|f)|box-d|(?:mask(?:$|-[ispro]|-cl)))|(tab-|column(?!-s)|text-align-l)|(ap)|(u|hy))/i.exec(i);return n?n[1]?1:n[2]?2:n[3]?3:5:0}(n);1&o&&(t+=`-webkit-${n}:${r};`),2&o&&(t+=`-moz-${n}:${r};`),4&o&&(t+=`-ms-${n}:${r};`);const l=function(i,n){var r=/^(?:(pos)|(background-i)|((?:max-|min-)?(?:block-s|inl|he|widt))|(dis))/i.exec(i);return r?r[1]?/^sti/i.test(n)?1:0:r[2]?/^image-/i.test(n)?1:0:r[3]?"-"===n[3]?2:0:/^(inline-)?grid$/i.test(n)?4:0:0}(n,r);return 1&l?t+=`${n}:-webkit-${r};`:2&l?t+=`${n}:-moz-${r};`:4&l&&(t+=`${n}:-ms-${r};`),t+=`${n}:${r};`,t}
...
var StarsRating$1 = StarsRating;

var RatingStars = React__default["default"].forwardRef(function (props, ref) {
    var rating = props.rating, disable = props.disable, size = props.size, margin = props.margin, stars = props.stars, obtainValue = props.obtainValue;
    ...
    var _a = React__default["default"].useState(rating), value = _a[0], setValue = _a[1];
    return (React__default["default"].createElement(StarsRating$1, { count: stars, defaultValue: value, value: value, disabled: disable, style: {
            style: { fontSize: "".concat(size, "px") },
            full: { star: { marginRight: "".concat(margin, "px") } },
            half: { star: { marginRight: "".concat(margin, "px") } },
            zero: { star: { marginRight: "".concat(margin, "px") } },
...
var debug$7 = src$2.exports('socket.io-client:url');
...
var debug = src$1.exports('socket.io-parser');
...
var Url = require$$1__default$1["default"];
...
var yeast$1 = yeast_1;
var debug$4 = src.exports('engine.io-client:polling');
...
var globalThis$3 = commonjsGlobal;
...
var yeast = yeast_1;
var debug$2 = src.exports('engine.io-client:websocket');
...
var debug$1 = src.exports('engine.io-client:socket');
var index$1 = indexof;
var parser$1 = lib;
...
Socket$1.prototype.filterUpgrades = function (upgrades) {
  ...
  for (var i = 0, j = upgrades.length; i < j; i++) {
    if (~index$1(this.transports, upgrades[i])) filteredUpgrades.push(upgrades[i]);
  }
...
var debug = src$2.exports('socket.io-client:socket');
var parseqs = parseqs$3;
...
var eio = lib$1.exports;
var Socket = socket.exports;
var Emitter = componentEmitter.exports;
var parser = socket_ioParser;
var on = on_1;
var bind = componentBind;
var debug = src$2.exports('socket.io-client:manager');
var indexOf = indexof;
var Backoff = backo2;
...
var parser = socket_ioParser;
var Manager = manager;
var debug = src$2.exports('socket.io-client');
...
Chart$1.register(CategoryScale, LinearScale, PointElement, LineElement, plugin_title, plugin_tooltip, plugin_legend, index);
var assetList = {
...
var BASE_URL = "wss://api-v4.zerion.io/";
var addressSocket = {
  namespace: "assets",
  socket: io("".concat(BASE_URL, "assets"), {
...
var Graphline = /*#__PURE__*/React__default["default"].forwardRef(function (props, ref) {
  var asset = props.asset,
      timeSet = props.timeSet,
      borderColor = props.borderColor;

  var _useState = React.useState([1, 2, 3, 4]),
      _useState2 = _slicedToArray(_useState, 2),
      graphData = _useState2[0],
      setGraphData = _useState2[1];

  var _useState3 = React.useState([1, 2, 3, 4]),
      _useState4 = _slicedToArray(_useState3, 2),
      graphLabels = _useState4[0],
      setGraphLabels = _useState4[1];

  var _useState5 = React.useState(null),
      _useState6 = _slicedToArray(_useState5, 2);
      _useState6[0];
      var setEmitter = _useState6[1];

  var fetchHistoricBitcoinData = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _yield$axios$get, data, Labels, Values;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios__default["default"].get("https://api.coingecko.com/api/v3/coins/bitcoin/market_chart?vs_currency=usd&days=".concat(timeList[timeSet]));

            case 2:
              _yield$axios$get = _context.sent;
              data = _yield$axios$get.data;
              Labels = data.prices.map(function (entry) {
                var epoch = new Date(0);
                epoch.setUTCMilliseconds(entry[0]);
                return epoch;
              });
              Values = data.prices.map(function (entry) {
                return entry[1];
              });
              console.log(Values);
    ...
    return function fetchHistoricBitcoinData() {
  ...
  React.useEffect(function () {
    if (["COVER", "ETH", "USDT"].includes(asset)) {
      var handleReceive = function handleReceive(data) {
        var Labels = Object.values(data.payload.charts)[0].map(function (entry) {
          var epoch = new Date(0);
          epoch.setUTCSeconds(entry[0]);
          return epoch;
        });
        var Values = Object.values(data.payload.charts)[0].map(function (entry) {
          return entry[1];
        });
        setGraphData(Values.reverse());
        setGraphLabels(Labels.reverse());
      ...
      var model = chartReqBodyEffect.scope[0];
      addressSocket.socket.once("received ".concat(addressSocket.namespace, " ").concat(model), handleReceive);
      return function unsubscribe() {
        addressSocket.socket.off("received ".concat(addressSocket.namespace, " ").concat(model), handleReceive);
...
var DonutGraph = React__default["default"].forwardRef(function (props, ref) {
    var labels = props.labels, data = props.data, backgroundColors = props.backgroundColors, borderColors = props.borderColors, borderWith = props.borderWith, hoverOffset = props.hoverOffset;
    var graphData = {
        labels: labels,
        datasets: [
            {
    ...
    return ((backgroundColors && borderColors && borderWith) ? (React__default["default"].createElement(Doughnut, { data: graphData })) : (React__default["default"].createElement("title", null, "Loading ...")));
});

Chart$1.register(CategoryScale, LinearScale, PointElement, LineElement, plugin_title, plugin_tooltip, plugin_legend, index);
var ContractPerformance = React__default["default"].forwardRef(function (props, ref) {
    var labels = props.labels, data = props.data, borderColor = props.borderColor;
    return (React__default["default"].createElement(Line, { data: {
            labels: labels,
            datasets: [
                {
