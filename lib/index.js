...
var FileUploader = function (props) {
    var endpoint = props.endpoint, fileType = props.fileType, onUpload = props.onUpload, imageSource = props.imageSource, design = props.design;
    ...
    React.useEffect(function () {
        ...
        axios
            ...
            .then(function (res) { return onUpload(res.data); })
...
var MainComp = function () {
    ...
    return (React__default["default"].createElement(GlobalContext.Provider, { value: [global, setGlobal] },
        React__default["default"].createElement("div", { style: { width: "150px", height: "150px" } },
            React__default["default"].createElement(FileUploader, { endpoint: "".concat(domain, "/cloudFunctions/uploadFile"), onUpload: function (newVal) { return handleNewImage("test", newVal); }, fileType: "FILE", imageSource: global && global.test ? global.test : "", design: "SIMPLE" }))));
};
