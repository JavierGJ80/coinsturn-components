...
var uploadFile = function (file, endpoint) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (React__default["default"].createElement(GlobalContext.Provider, { value: [global, setGlobal] },
        React__default["default"].createElement("div", { style: { width: "150px", height: "150px" } },
            React__default["default"].createElement(FileUploader, { endpoint: "".concat(process.env.REACT_APP_DOMAIN
                    ...
                    : "http://localhost:8080", "/cloudFunctions/uploadFile"), onUpload: function (newVal) { return handleNewImage("test", newVal); }, fileType: "FILE", imageSource: global && global.test ? global.test : "", design: "SIMPLE" }))));
};
