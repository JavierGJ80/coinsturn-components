...
var FileUploader = function (props) {
    var endpoint = props.endpoint, fileType = props.fileType, updateValue = props.updateValue, imageSource = props.imageSource, design = props.design;
    ...
    React.useEffect(function () {
        ...
        axios
            ...
            .then(function (res) { return updateValue(res.data.imgLink); })
    ...
    if (design === "DETAILED")
        return React__default["default"].createElement("div", { className: "uploader-detailed-main" });
        ...
        React__default["default"].createElement("div", { className: "uploader-simple-img-container", onMouseEnter: function () { return setIsHovered(true); } },
            React__default["default"].createElement("img", { className: "uploader-simple-img ".concat(isHovered ? "uploader-blurred" : ""), src: fileType === "IMAGE"
                    ? imageSource
                        ...
                        : defaultImage
                    : defaultFile })),
        isHovered ? (React__default["default"].createElement("label", { className: "uploader-simple-text", onMouseLeave: function () { return setIsHovered(false); } },
            "Upload an Image",
            React__default["default"].createElement("input", { type: "file", className: "uploader-input", onChange: onChangeFile }))) : (React__default["default"].createElement(React__default["default"].Fragment, null))));
};
...
var GlobalContext = React.createContext([undefined, undefined]);
var MainComp = function () {
    var _a = React.useState(), global = _a[0], setGlobal = _a[1];
    var _b = React.useContext(GlobalContext), gc = _b[0], setGc = _b[1];
    var handleNewImage = function (name, newPath) {
        var _a;
        if (!setGc)
            return;
        setGc(__assign(__assign({}, gc), (_a = {}, _a[name] = newPath, _a)));
    };
    ...
    return (React__default["default"].createElement(GlobalContext.Provider, { value: [global, setGlobal] },
        React__default["default"].createElement("div", { style: { width: "150px", height: "150px" } },
            React__default["default"].createElement(FileUploader, { endpoint: "".concat(domain, "/cloudFunctions/uploadFile"), updateValue: function (newVal) { return handleNewImage("test", newVal); }, fileType: "IMAGE", imageSource: gc && gc.test ? gc.test : "", design: "SIMPLE" }))));
};
