    ...
    <div className="tokenSpecificMainContainer" style={{ backgroundColor :  backgroundColor, color : fontColor }}>
      ...
      <div className="tokenSpecificRightContainer">
        <div className="tokenSpecificStats">
          ...
          <div className="tokenSpecificStatsDiv">
            <header>{"Capitalizacion de mercado"}</header>
            {/* @ts-ignore */}
            <text>$ {stats.market_cap}</text>
          </div>
          <div className="tokenSpecificStatsDiv">
            <header>{"Ranking Capitalizacion de mercado"}</header>
            {/* @ts-ignore */}
          ...
          <div className="tokenSpecificStatsDiv">
            ...
            {/* @ts-ignore */}
            <text>{stats.total_volume} {stats.symbol}</text>
          </div>
          <div className="tokenSpecificStatsDiv">
            <header>{"Maximo en 24h"}</header>
            {/* @ts-ignore */}
            <text>$ {stats.high_24h}</text>
          </div>
          <div className="tokenSpecificStatsDiv">
            <header>{"Minimo en 24h"}</header>
            {/* @ts-ignore */}
            <text>$ {stats.low_24h}</text>
          </div>
          <div className="tokenSpecificStatsDiv">
            <header>{"Total en circulación"}</header>
            {/* @ts-ignore */}
            <text>{stats.circulating_supply} {stats.symbol}</text>
          </div>
        </div>
